...
[/code]
		', '2020-04-03', '2020-04-03', '10.123.254.53       ');
INSERT INTO notes VALUES (2, 'anonymous           ', 'linux, date, установить системную дату/время                                                                                                                                                                                                                   ', '
date -s &amp;quot;2015-05-27 14:53:00&amp;quot;

		', '2020-03-31', '2020-03-31', '10.16.194.154       ');
INSERT INTO notes VALUES (3, 'anonymous           ', 'grep                                                                                                                                                                                                                                                           ', '
grep -r --include=*.php &amp;quot;search string&amp;quot; /path/to/dir
		', '2020-03-12', '2020-03-12', '10.9.216.41         ');
INSERT INTO notes VALUES (4, 'nodejs, update      ', 'обновить nodejs                                                                                                                                                                                                                                                ', '
[code]
First update npm,
...
[url]https://getpocket.com/a/read/2116352733 | В чем разница между GPT и MBR разделами диска[/url]
...
Francesco Bergamini (Italian, 1815–1883)[br]
[url] http://www.artnet.com/artists/francesco-bergamini/ | www.artnet.com[/url]
...
убрать из разметки все комментарии
[code]
...
[/code]
		...
		', '2017-09-14', '2017-09-14', '37.193.108.45       ');
INSERT INTO notes VALUES (22, 'anonymous           ', 'apache + mod_python                                                                                                                                                                                                                                            ', '
