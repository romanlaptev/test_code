...
function agropit_add_cart_in_post(){
	...
	if( is_single() ){
		...
		<?php if( post_is_in_descendant_category( get_term_by( 'slug', 'sell-tu', 'category' )->term_id ) and is_single() ){ ?>
			<div class="sale" id="sale-tu"><?php layerslider(2) ?></div><?php } ?>
...
<img src="//top-fwz1.mail.ru/counter?id=2419364;js=na" style="border:0;" height="1" width="1" alt="Рейтинг@Mail.ru" />
</div>
</noscript>
<!-- //Rating@Mail.ru counter -->
<!-- Rating@Mail.ru logo -->
